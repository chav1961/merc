...
public class VarDescriptorTest {
	...
	public void basicTest() {
		...
		final VarDescriptor				desc1 = new VarDescriptorImpl(0,nameId1,String.class,false,false,0);
		...
		final VarDescriptor				desc2 = new VarDescriptorImpl(0,nameId2,String.class,false,true,0,desc1);
		...
		final VarDescriptor				desc3 = new VarDescriptorImpl(0,nameId3,String.class,false,true,0,desc1,desc1);
		...
		final VarDescriptor				desc4 = new VarDescriptorImpl(0,nameId1,String.class,false,true,1,desc1);
		...
		final VarDescriptor				desc5 = new VarDescriptorImpl(0,nameId1,String.class,false,true,2,desc1);
		...
		final VarDescriptor				desc6 = new VarDescriptorImpl(0,nameId1,new VarDescriptor[0],String.class,0);
		...
		final VarDescriptor				desc7 = new VarDescriptorImpl(0,nameId1,new VarDescriptor[]{desc1},String.class,0);
		...
		final VarDescriptor				desc8 = new VarDescriptorImpl(0,nameId1,new VarDescriptor[]{desc1,desc2},String.class,0);
		...
		final VarDescriptor				desc9 = new VarDescriptorImpl(0,nameId1);
